...
export function DevicePredictionDevAdd() {
  ...
  async function handleTrain() {
    ...
    try {
      const es = new EventSource("http://localhost:8000/api/clustering/train_dev_add/stream")
  ...
  async function handlePredict(e) {
    ...
    try {
      ...
      const response = await fetch("http://localhost:8000/api/clustering/predict_dev_add", {
        method: "POST",
        credentials: "include",
        headers: {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto text-gray-800">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">
        Prédiction de Dev_Add (Adresse dispositif)
      </h1>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <p className="text-gray-600 mb-4">
          ...
          Le modèle apprend à prédire le Dev_Add (adresse du dispositif) à partir des caractéristiques radio.
        </p>
        ...
        {trainingStatus && (
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-blue-800 font-semibold">{trainingStatus}</p>
          </div>
        )}
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold mb-4 text-gray-700">
          2. Prédiction de Dev_Add
        </h2>
        <p className="text-gray-600 mb-6">
          Entrez les caractéristiques radio d'un paquet pour prédire le Dev_Add (adresse du dispositif) associé.
        </p>
        ...
        <form onSubmit={handlePredict} className="space-y-6">
          ...
          >
            {isPredicting ? "Prédiction en cours..." : "Prédire le Dev_Add"}
          </button>
        </form>
            ...
            {predictionResult.prediction && (
              <div className="mb-4">
                <div className="text-2xl font-bold text-blue-800 mb-2">
                  Dev_Add prédit: {predictionResult.prediction}
                </div>
